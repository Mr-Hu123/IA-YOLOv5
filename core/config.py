...
parser.add_argument('--vocfog_valdata_dir',     dest='vocfog_valdata_dir',              default='./data/data_vocfog/val/JPEGImages/',
                    help='the dir contains ten levels synthetic foggy images')
...
parser.add_argument('--WEIGHT_FILE',            dest='WEIGHT_FILE', nargs='*',          default='./ckpts/IA_YOLOv5_test-loss=15.2691.ckpt-80', help='folder of the training data')
parser.add_argument('--pre_train',              dest='pre_train',                       default='ckpts/IA_YOLOv5_test-loss=15.2691.ckpt-80',   help='the path of pretrained models if is not null. not used for now')
...
__C.YOLO.MODEL_SAVE_PATH        = './model'
__C.YOLO.MODEL_FILE             = './model/model.file'
__C.YOLO.LOSS_SAVE_FILE         = './model/loss.file'
...
#__C.TRAIN.ANNOT_PATH                       = './data/dataset_fog/voc_norm_train.txt'
# __C.TRAIN.FISRT_STAGE_EPOCHS              = 0
# __C.TRAIN.SECOND_STAGE_EPOCHS             = 80
#__C.TRAIN.INITIAL_WEIGHT                   = 'ckpts/IA_YOLOv5_test-loss=15.2691.ckpt-80'
...
#__C.TEST.ANNOT_PATH                = './data/dataset_fog/voc_norm_test.txt'
#__C.TEST.WRITE_IMAGE_PATH          = 'imgs/detection/'
#__C.TEST.WEIGHT_FILE               = 'cpkts/IA_YOLOv5_test-loss=15.2691.ckpt-80'